...
@Component({
  selector: 'app-action-sociale',
  templateUrl: './action-sociale.component.html',
  styleUrls: ['./action-sociale.component.scss'],
})
export class ActionSocialeComponent implements OnInit {
  societeData: any = {
    Presentation: [
      {
        titre: 'Resume',
