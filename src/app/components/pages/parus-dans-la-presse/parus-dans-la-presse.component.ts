...
@Component({
  selector: 'app-parus-dans-la-presse',
  templateUrl: './parus-dans-la-presse.component.html',
  styleUrls: ['./parus-dans-la-presse.component.scss'],
})
export class ParusDansLaPresseComponent implements OnInit {
  societeData: any = {
    Presentation: [
      {
        titre: 'Resume',
