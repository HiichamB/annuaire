...
@Component({
  selector: 'app-filiale-partenaire',
  templateUrl: './filiale-partenaire.component.html',
  styleUrls: ['./filiale-partenaire.component.scss'],
})
export class FilialePartenaireComponent implements OnInit {
  societeData: any = {
    Presentation: [
      {
        titre: 'Resume',
